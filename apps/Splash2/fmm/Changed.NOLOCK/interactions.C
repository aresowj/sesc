...
#endif
      /* Begin synchronization condition release */
      asm volatile ("jal sesc_release_begin":::"ra");
      b->interaction_synch = 1;
      asm volatile ("jal sesc_release_end\njal sesc_change_epoch":::"ra");
      /* End synchronization condition release */
      /* Replaced code: */
#if 0
...
DownwardPass (int my_id, box *b)
{
   ...
   if (b->parent != NULL) {
      /* Begin wait in a synchronization condition */
      asm volatile ("jal sesc_change_epoch\njal sesc_acquire_begin":::"ra");
      if(b->parent->interaction_synch != 0)
	tls_acquire_retry();
      asm volatile ("jal sesc_acquire_end":::"ra");
      /* End of wait in a synchronization condition */
      /* Replaced code: */
#if 0
...
VListInteraction (int my_id, box *source_box, box *dest_box)
{
   ...
   if (source_box->type == CHILDLESS) {
      /* Begin wait in a synchronization condition */
      asm volatile ("jal sesc_change_epoch\njal sesc_acquire_begin":::"ra");
      if(source_box->interaction_synch != 1)
	tls_acquire_retry();
      asm volatile ("jal sesc_acquire_end":::"ra");
      /* End of wait in a synchronization operation */
#if 0 /* Replaced code */
	 ...
	 /* wait */;
      ...
      /* Begin wait in a synchronization condition */
      asm volatile ("jal sesc_change_epoch\njal sesc_acquire_begin":::"ra");
      if(source_box->interaction_synch != source_box->num_children)
	tls_acquire_retry();
      asm volatile ("jal sesc_acquire_end":::"ra");
      /* End of wait in a synchronization operation */
#if 0 /* Replaced code */
