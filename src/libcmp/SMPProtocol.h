...
public:
    ...
    // JJO
    virtual void readReply(MemRequest *mreq) {
        I(0);
    }
    virtual void freeResource(MemRequest *mreq) {
        I(0);
    }
    ...
    //virtual void sendInvalidateAck(SMPMemRequest *sreq, bool ts);

    virtual void readMissHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void writeMissHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void invalidateHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void invalidateReplyHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void readMissAckHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void writeMissAckHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void invalidateAckHandler(SMPMemRequest *sreq) {
        I(0);
    }
    virtual void finalizeInvReply(SMPMemRequest *sreq) {
        I(0);
    }
    // JJO
    virtual void dirReplyHandler(SMPMemRequest *sreq) {
        I(0);
    }
    ...
    virtual void dataHandler(SMPMemRequest *sreq) {
        I(0);
    }
